...
const items = [
  {
    ...
    description: 'Proficient in HTML5, CSS3, JavaScript, and various front-end frameworks like React.js and Bootstrap.'
  },
  {

    icon: <StorageIcon />,
    title: 'Back-end Development:',
    description: 'Experienced in Node.js, Express, MongoDB, and MySQL for building robust server-side applications.',
  },
  {
  ...
  },
  {
    ...
    description: 'Familiar with Git for version control and deploying applications using platforms like GitHub and Heroku.',
  },
  {
    icon: <DesignServicesIcon />,
    title: 'UI/UX Design Principles:',
    description:'Knowledgeable about designing intuitive user interfaces and enhancing user experience through responsive design and accessibility practices.',
  },
];
      ...
      >
        ...
        >
          ...
          I am enthusiastic about leveraging my technical skills and
            ...
            delivering high-quality results that exceed expectations.          </Typography>
            </Box>
